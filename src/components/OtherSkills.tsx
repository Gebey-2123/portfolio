  ...
  video: [
    {
      ...
      videoLocal: "/videos/video editing1.mp4",
    ...
    },
    {
      ...
      videoLocal: "/videos/video editing2.mp4",
    ...
    },
    {
      ...
      videoLocal: "/videos/video editing3.mp4",
    ...
    },
    {
      ...
      videoLocal: "/videos/video editing4.mp4",
...
export default function OtherSkills() {
  ...
  const videoMap: Record<string, string[]> = useMemo(() => ({
    ...
    "video-3": ["/videos/video editing3.mp4", "/video editing3.mp4"],
    "video-4": ["/videos/video editing4.mp4", "/video editing4.mp4"],
